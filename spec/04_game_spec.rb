...
describe 'Game' do
  ...
  before(:all) do
    ...
    @game = Game.new(player_one: @player_one, player_two: @player_two, board: @board)
  end
  ...
  describe '#player_one' do
    it 'provides access to player_one' do
      expect(@game.player_one).to eq(@player_one)
    end
  end

  describe '#player_two' do
    it 'provides access to player_two' do
  ...
  #
  #     expect(@game.player_one).to receive(:gets).and_return("1")
  #
  #     @game.turn
  #   end
  #
  ...
  #     allow($stdout).to receive(:puts)
  #
  #     expect(@game.player_one).to receive(:gets).and_return("invalid")
  #     expect(@game.player_one).to receive(:gets).and_return("1")
  #
  #     @game.turn
  #   end
