class TicTacToeCLI
  def initialize
    puts "Well hello there, welcome to Tic-Tac-Toe!"
    puts "To leave at any time, type 'quit'."
  end

  def start
    puts "How many players do we have today? Enter 0, 1, or 2."
    input = gets.chomp
    if input == 'quit'
      exit
    elsif input == "0"
      ...
      puts "Great! You chose to play against the computer. The following board will display your possible positions to move:"
      puts "\n"
      puts " 1 | 2 | 3 "
      puts "------------"
      puts " 4 | 5 | 6 "
