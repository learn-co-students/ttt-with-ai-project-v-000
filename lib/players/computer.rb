...
module Players
  ...
  class Computer < Player
    ...
    def move(board)
      ...
      elsif board.turn_count == 1 #if 2nd move, play center, if center taken, play corner 1
        if !board.taken?(5)
          move = "5"
        else
          move = "1"
        end
      elsif board.turn_count == 2 #if 3rd move, play first open corner: iterate through all corners, test against taken?
