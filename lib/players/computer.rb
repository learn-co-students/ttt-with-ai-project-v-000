module Players
    ...
    class Computer < Player
          ...
          def move(board) # returns a valid position for the computer to move
            ...
            # If going second and the middle square is taken, take the upper-right corner square.
          elsif board.turn_count == 3
              move = "3"

            # If you went first (and took the middle), take bottom corner with your second move.
