#array.sample chooses an index at random and returns the value; does not repeat itself unless all choices have been taken.
...
module Players
  class Computer < Player
    ...
    def move(board)
      ...
      def best_move(player) #seems broken now :()
        case player
