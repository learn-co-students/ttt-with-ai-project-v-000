class Computer < Player
  ...
  def offensive(board)
    if board.cells[0] == self.token && board.cells[1] == self.token && board.cells[2] != self.opp_token
      self.valid_moves[2]
    elsif board.cells[0] == self.token && board.cells[2] == self.token && board.cells[1] != self.opp_token
      self.valid_moves[1]
    elsif board.cells[1] == self.token && board.cells[2] == self.token && board.cells[0] != self.opp_token
      self.valid_moves[0]
    elsif board.cells[3] == self.token && board.cells[4] == self.token && board.cells[5] != self.opp_token
      self.valid_moves[5]
    elsif board.cells[3] == self.token && board.cells[5] == self.token && board.cells[4] != self.opp_token
      self.valid_moves[4]
    elsif board.cells[4] == self.token && board.cells[5] == self.token && board.cells[3] != self.opp_token
      self.valid_moves[3]
    elsif board.cells[6] == self.token && board.cells[7] == self.token && board.cells[8] != self.opp_token
      self.valid_moves[8]
    elsif board.cells[6] == self.token && board.cells[8] == self.token && board.cells[7] != self.opp_token
      self.valid_moves[7]
    elsif board.cells[7] == self.token && board.cells[8] == self.token && board.cells[6] != self.opp_token
      self.valid_moves[6]
    elsif board.cells[0] == self.token && board.cells[3] == self.token && board.cells[6] != self.opp_token
      self.valid_moves[6]
    elsif board.cells[0] == self.token && board.cells[6] == self.token && board.cells[3] != self.opp_token
      self.valid_moves[3]
    elsif board.cells[3] == self.token && board.cells[6] == self.token && board.cells[0] != self.opp_token
      self.valid_moves[0]
    elsif board.cells[1] == self.token && board.cells[4] == self.token && board.cells[7] != self.opp_token
      self.valid_moves[7]
    elsif board.cells[1] == self.token && board.cells[7] == self.token && board.cells[4] != self.opp_token
      self.valid_moves[4]
    elsif board.cells[4] == self.token && board.cells[7] == self.token && board.cells[1] != self.opp_token
      self.valid_moves[1]
    elsif board.cells[2] == self.token && board.cells[5] == self.token && board.cells[8] != self.opp_token
      self.valid_moves[8]
    elsif board.cells[2] == self.token && board.cells[8] == self.token && board.cells[5] != self.opp_token
      self.valid_moves[5]
    elsif board.cells[5] == self.token && board.cells[8] == self.token && board.cells[2] != self.opp_token
      self.valid_moves[2]
    elsif board.cells[0] == self.token && board.cells[4] == self.token && board.cells[8] != self.opp_token
      self.valid_moves[8]
    elsif board.cells[0] == self.token && board.cells[8] == self.token && board.cells[4] != self.opp_token
      self.valid_moves[4]
    elsif board.cells[4] == self.token && board.cells[8] == self.token && board.cells[0] != self.opp_token
      self.valid_moves[0]
    elsif board.cells[6] == self.token && board.cells[4] == self.token && board.cells[2] != self.opp_token
      self.valid_moves[2]
    elsif board.cells[2] == self.token && board.cells[4] == self.token && board.cells[6] != self.opp_token
      self.valid_moves[6]
    elsif board.cells[2] == self.token && board.cells[6] == self.token && board.cells[4] != self.opp_token 
      self.valid_moves[4]
    end
  end
